...
const perks = [
  {
    ...
    description:
      'Get your assets instantly delivered to your mail after purchase.',
  },
  {
      ...
      <MaxWidthWrapper>
        <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
          ...
          <p className='mt-6 text-lg max-w-prose text-muted-foreground'>
            Welcome to BlueHippo. Every asset on our platform is verified by our
            team to ensure our highest quality standards.
          </p>
          <div className='flex flex-col sm:flex-row gap-4 mt-6'>
            {/* buttonVariants comes from Button ui component */}
